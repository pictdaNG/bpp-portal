                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        @foreach ($getUploadfiles as $data)
                            <div class="col-md-6 text-center" style="padding: 8px;"><a href="{{ asset('https://bpp-portal-live.s3.amazonaws.com/uploads/'.$data->key)}}" class="btn btn-s-md btn-primary btn-rounded"><i class="fa fa-file"></i>{{ ' '.strtoupper($data['name']) }}</a></div>
                        @endforeach
                        @endif  
