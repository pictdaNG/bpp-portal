...
<section class="hbox stretch">
    <section class="vbox">
        ...
        <section class="panel panel-info">
            ...
            <form class="bs-example form-horizontal" action="{{ route('deleteAdvertType') }}" method="POST">

                {{csrf_field()}}
                <div class="row wrapper">
                    <div class="col-sm-5 m-b-xs">
                        <a href="##advertType" data-toggle="modal" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Advert Type</a> 
                ...
                <div class="table-responsive">
                    <table class="table table-striped b-t b-light">
                        ...
                        <tbody id="equipements"> 
                            @if(sizeof($advertTypes) > 0)
                                <?php $i = 1; ?>
                                @foreach ( $advertTypes as $data)
                                    <tr>
...
<div class="modal fade" id="advertType">
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form class="bs-example form-horizontal" action="{{ route('storeAdvertType') }}" method="POST">
    {{csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-lg-10">
            <input type="text" class="form-control"  required name="name" placeholder="Advert Type" value="">
