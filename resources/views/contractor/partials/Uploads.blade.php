            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $cac ? '' : 'disabled' }} id="cac_preview_btn" href="{{ $cac ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $cac->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $tcc ? '' : 'disabled' }} id="tcc_preview_btn" href="{{ $tcc ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $tcc->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $tin ? '' : 'disabled' }} id="tin_preview_btn" href="{{ $tin ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $tin->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $pencom ? '' : 'disabled' }} id="pencom_preview_btn" href="{{ $pencom ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $pencom->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $itf ? '' : 'disabled' }} id="itf_preview_btn" href="{{ $itf ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $itf->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $audited_account ? '' : 'disabled' }} id="audited_account_preview_btn" href="{{ $audited_account ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $audited_account->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        <a {{ $swon_affidavit ? '' : 'disabled' }} id="swon_affidavit_preview_btn" href="{{ $swon_affidavit ? asset('https://bpp-pictda.s3.amazonaws.com/uploads/' . $swon_affidavit->key) : '#' }}" class="btn btn-default"><i class="fa fa-search"></i> Preview</a>
      ...
      xhr.onreadystatechange = function(data){ 
        if ( xhr.readyState == 4 ) {
          if ( xhr.status == 200) {
            ...
            $('#' + previewBtn).attr('href',  '{{ asset('https://bpp-pictda.s3.amazonaws.com/uploads/') }}' + data.key);
